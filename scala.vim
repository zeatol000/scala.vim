...
syn keyword scalaKeyword catch do else final finally for forSome if match
			\ return throw try while yield macro then
...
syn keyword scalaKeyword def var	end given													nextgroup=scalaNameDefinition skipwhite
...
syn match scalaWildcard "?"
hi def link scalaUnimportant Comment
...
syn match scalaUScoreCapWord /\<[A-Z_][a-zA-Z0-9$_]*\>/
...
syn keyword scalaKeywordModifier abstract override final lazy implicit private
			\ protected sealed super inline infix opaque transparent[] null
